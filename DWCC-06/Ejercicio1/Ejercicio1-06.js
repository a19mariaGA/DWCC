...
//O texto do segundo parágrafo.
    ...
    let segParrafo= document.getElementsByTagName("p")[1].childNodes[0].nodeValue;
...
penultimoSrc =document.getElementsByTagName('a')[penultimoSrc.length - 2].href;
...
console.log("Número de ligazóns do primeiro parágrafo: " + enlPriParrafo);
